...
class Simulator():
    ...
    def update_state(self,s,a,human=False):
        ...
        l = 6.85
        ### change safety constraints: guarantee no crash even when the leading car break at its maximum deceleration
        #x_ = x + v * self.dt + (1 / 2) * a_ * self.dt ** 2
        ...
        xl_3 = xl_ + vl_*self.dt + (1/2)*a_min_hv*self.dt**2 ### when the leading car break at its maximum deceleration xl_3
        gap = xl_3 - x3 -l - min_s ### change safety constraints: guarantee no crash even when
